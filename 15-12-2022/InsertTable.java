...
public class InsertTable {
	...
	Scanner sc = new Scanner(System.in);  // scanner class sc object create
	int RegistrationID ,PhoneNo,e_salary,Yearof_Passing12th ; // key value
	String S_Name, Address,Course_Dept;
	double Marks_10th,Marks_12th;

       //saving  student details in database
		public void saveMenuDriven()throws SQLException{ // method
	    	System.out.println("Enter RegistrationID  :"); // print 
	    	...
	    	stmt.setInt(1, RegistrationID);// insert to database
	    	...
	    	stmt.executeUpdate();
	    	ResultSet rs=stmt.executeQuery("select * Admission_Details");  // show data table
			while(rs.next()) {
